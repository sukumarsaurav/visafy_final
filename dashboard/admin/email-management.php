...
if (isset($_POST['send_email'])) {
    ...
    if (empty($recipient_email) || empty($subject) || empty($content)) {
        ...
        if ($stmt->execute()) {
            $success_message = "Email has been queued for sending";
        } else {
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="compose-tab">
                    ...
                    <form method="post" action="" class="form-container">
                        ...
                        <button type="submit" name="send_email" class="btn primary-btn">Send Email</button>
                    </form>
                </div>
                                ...
                                <?php foreach ($sent_emails as $email): ?>
                                    <tr>
                                        ...
                                        <td class="actions-cell">
                                            <button class="btn-action view-email" data-id="<?php echo $email['id']; ?>" data-type="sent">
                            ...
                            <tbody>
                                <?php foreach ($received_emails as $email): ?>
                                    <tr>
                                        ...
                                        <td class="actions-cell">
                                            <button class="btn-action view-email" data-id="<?php echo $email['id']; ?>" data-type="received">
                                                <i class="fas fa-eye"></i>
                                            </button>
